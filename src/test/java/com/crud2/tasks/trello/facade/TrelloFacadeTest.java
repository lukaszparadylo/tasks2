...
import com.crud2.tasks.trello.validator.TrelloValidator;
...
class TrelloFacadeTest {
    ...
    void shouldFetchEmptyList() {
        ...
        List<TrelloBoard> trelloBoard = trelloValidator.validateTrelloBoards(mappedTrelloBoards);
        // Then
        assertThat(trelloBoardDtos).isNotNull();
        assertThat(trelloBoardDtos.size()).isEqualTo(0);
        assertThat(trelloBoard.size()).isNotNull();
        assertThat(trelloBoard.size()).isEqualTo(0);
    }
    @Test
